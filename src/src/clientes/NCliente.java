...
public class NCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {Cancelar, Salvar, Voltar});
...
try{
    ...
    PreparedStatement pst = conec.conn.prepareStatement("insert into estados(nome,tel,end,email)values(?,?,?,?)");//passagem do sql para inserção
            pst.setString(1,nome.getText());//passagem dos parametros
